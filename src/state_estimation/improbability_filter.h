...
class ImprobabilityFilter : public KalmanFilter {
 public:
  ImprobabilityFilter(const pose_2d::Pose2Df& observed_pose,
...
#endif  //  SRC_STATE_ESTIMATION_IMPROBABILITY_FILTER_H_